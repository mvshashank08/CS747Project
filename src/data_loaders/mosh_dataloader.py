...
class mosh_dataloader(Dataset):
    ...
    def _load_data_set(self):
        ...
        anno_file_path = os.path.join(self.data_folder, 'mosh_annot.pkl')
        with open(anno_file_path, 'rb') as fp:
            mosh = pickle.load(fp, encoding="latin1")
            self.shapes = mosh['shapes']
            self.poses = mosh['poses']
